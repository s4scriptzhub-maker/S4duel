...
screenGui.Name = "S4duels_Premium_Restored"
...
-- 1. LOCK GUI (Independent & Draggable)
...
closeSettings.Font = Enum.Font.GothamBold; closeSettings.TextSize = 18
Instance.new("UICorner", closeSettings).CornerRadius = UDim.new(1, 0)
local cStroke = Instance.new("UIStroke", closeSettings)
cStroke.Color = Color3.fromRGB(255, 50, 70); cStroke.Thickness = 1.2
